...
# Nonlinear pressure residual. The fixed-stress outer iteration updates phi_iter
...
while step < total_steps:
    ...
    history_rows.append(
        [
            ...
            iteration,
            last_newton_iterations,
        ]
    )

    print(
        f"step={step:03d} day={time_days:7.2f} "
        f"fixed_stress={iteration:02d} newton={last_newton_iterations:02d} "
